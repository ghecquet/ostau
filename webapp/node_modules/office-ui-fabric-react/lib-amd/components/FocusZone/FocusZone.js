define(["require", "exports", "tslib", "react", "./FocusZone.types", "../../Utilities", "@uifabric/merge-styles"], function (require, exports, tslib_1, React, FocusZone_types_1, Utilities_1, merge_styles_1) {
    "use strict";
    ...
    var FocusZone = /** @class */ (function (_super) {
        ...
        FocusZone.prototype.render = function () {
            ...
            return (React.createElement(Tag, tslib_1.__assign({ role: "presentation" }, divProps, rootProps, { 
                // Once the getClassName correctly memoizes inputs this should
                // be replaced so that className is passed to getRootClass and is included there so
                // the class names will always be in the same order.
                className: Utilities_1.css(getRootClass(), className), ref: this._root, "data-focuszone-id": this._id, "aria-labelledby": ariaLabelledBy, "aria-describedby": ariaDescribedBy, onKeyDown: this._onKeyDown, onFocus: this._onFocus, onMouseDownCapture: this._onMouseDown }), this.props.children));
        };
        /**
