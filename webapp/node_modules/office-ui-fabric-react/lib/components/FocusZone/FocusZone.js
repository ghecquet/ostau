...
var FocusZone = /** @class */ (function (_super) {
    ...
    FocusZone.prototype.render = function () {
        ...
        return (React.createElement(Tag, tslib_1.__assign({ role: "presentation" }, divProps, rootProps, { 
            ...
            className: css(getRootClass(), className), ref: this._root, "data-focuszone-id": this._id, "aria-labelledby": ariaLabelledBy, "aria-describedby": ariaDescribedBy, onKeyDown: this._onKeyDown, onFocus: this._onFocus, onMouseDownCapture: this._onMouseDown }), this.props.children));
    };
    /**
