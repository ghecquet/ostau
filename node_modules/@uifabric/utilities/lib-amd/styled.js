define(["require", "exports", "tslib", "react", "./array", "./customizations/Customizations", "./customizations/CustomizerContext"], function (require, exports, tslib_1, React, array_1, Customizations_1, CustomizerContext_1) {
    "use strict";
        ...
        var Wrapped = /** @class */ (function (_super) {
            ...
            Wrapped.prototype._updateStyles = function (customizedStyles) {
                if (!this._styles || customizedStyles !== this._styles[1] || !!this.props.styles) {
                    ...
                    this._styles = array_1.flatten([baseStyles, customizedStyles, this.props.styles]);
                }
            };
